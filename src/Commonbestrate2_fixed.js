...
export default function Commonbestrate2_fixed(props){
    const { lockShow } = props;
    const dispatch=useDispatch()
    const navigate = useNavigate();

    const handleClick=()=>{
        dispatch(set_exchangename("Exolix_fixed"));
                                            ...
                                            <div data-v-a46bbb88="" data-v-4860c0fa="" className="row step1-table__desktop">
                                                ...
                                                <div data-v-49591a1a="" data-v-4860c0fa="" className="column col-12 col-md-4 col-lg-4" data-v-a46bbb88="">
                                                    <div data-v-4860c0fa="" className="step1-field step1-table__field-type" data-v-49591a1a="">
                                                        ...
                                                        <div data-v-2d10d984="" className="partner-item" partner="exolix" value="exolix" from-amount="0.1" to-amount="exolix" min="0.0021" max="0" code="btc" network="btc" align="start">

                                                            <div>
                                                                <img data-v-2d10d984="" alt="exolix" src="https://storage.swapspace.co/static/exolox-icon.png" className="partner-item__image" />
