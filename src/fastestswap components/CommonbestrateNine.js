...
import fixedfloat from "../images/0x0.png"
...
export default function Commonbestrate9(props){
    ...
    return(
        <>
        <div data-v-4860c0fa="" className="step1-table__row" style={props.fixedfloatb2==0 || props.fixedfloatb2==undefined?{display:"none"}:{display:"block"}}>
                                            ...
                                            <div data-v-a46bbb88="" data-v-4860c0fa="" className="row step1-table__desktop">
                                                ...
                                                <div data-v-49591a1a="" data-v-4860c0fa="" className="column col-12 col-md-4 col-lg-4" data-v-a46bbb88="">
                                                    <div data-v-4860c0fa="" className="step1-field step1-table__field-type" data-v-49591a1a="">
                                                        ...
                                                        <div data-v-2d10d984="" className="partner-item" partner="quickex" value="quickex" from-amount="0.1" to-amount="quickex" min="0.105" max="114" code="btc" network="btc" align="start"><img data-v-2d10d984="" alt="Letsexchange" src={fixedfloat} className="partner-item__image" />
                                                            <div>
