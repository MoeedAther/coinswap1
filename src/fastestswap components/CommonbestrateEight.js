...
export default function Commonbestrate8(props){
    ...
    return(
        <>
        <div data-v-4860c0fa="" className="step1-table__row" style={props.letsexchangeb2==0 || props.letsexchangeb2==undefined?{display:"none"}:{display:"block"}}>
